  ...
  return (
    <div className="configure-service-box">
      <div className="box-header">
        <h3 className="display-font" style={{ fontSize: '1.5rem', color: 'var(--on-surface)', display: 'flex', alignItems: 'center', gap: '1rem', margin: 0 }}>
          <span className="material-symbols-outlined" style={{ fontSize: '2.2rem', color: 'var(--primary)' }}>settings_suggest</span>
          NEW SERVICE
        </h3>
      ...
      <div className="config-footer">
        <div className="deploy-actions">
          <Button variant="outline" icon="sync_alt" onClick={onDeployToAll}>Deploy to All</Button>
          <Button icon="rocket_launch" onClick={onDeploy}>Deploy to {uavDisplayName(activeUavId)}</Button>
