  ...
  return (
    <div className="stack-header">
      ...
      >
        ...
        <h2
          className="env-title display-font"
          style={{ fontSize: "2.5rem", marginBottom: 0, lineHeight: 1 }}
        >
      ...
      <div className="stack-header-actions">
        <div style={{ display: "flex", gap: "0.75rem" }}>
          <Button variant="outline" icon="sync" onClick={syncAll}>
            Sync All
          </Button>
          <Button variant="danger" icon="clear_all" onClick={clearAll}>
            Clear
          </Button>
        </div>
      </div>
